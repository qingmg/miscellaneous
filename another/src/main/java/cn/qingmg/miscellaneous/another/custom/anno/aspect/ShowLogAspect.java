package cn.qingmg.miscellaneous.another.custom.anno.aspect;

import cn.qingmg.miscellaneous.another.custom.anno.ShowLog;
import cn.qingmg.miscellaneous.another.util.AspectUtil;
import cn.qingmg.miscellaneous.another.util.RegexUtil;
import cn.qingmg.miscellaneous.another.util.RequestUtil;
...
public class ShowLogAspect {
    ...
    @Pointcut("@annotation(cn.qingmg.miscellaneous.another.custom.anno.ShowLog)")
